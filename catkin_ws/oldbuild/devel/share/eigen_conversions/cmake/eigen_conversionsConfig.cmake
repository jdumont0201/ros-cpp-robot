...
if("TRUE" STREQUAL "TRUE")
  set(eigen_conversions_SOURCE_PREFIX /home/jbmdumont/catkin_ws/src/geometry/eigen_conversions)
  set(eigen_conversions_DEVEL_PREFIX /home/jbmdumont/catkin_ws/devel)
  ...
  set(eigen_conversions_INSTALL_PREFIX /home/jbmdumont/catkin_ws/install)
...
if(NOT "/home/jbmdumont/catkin_ws/src/geometry/eigen_conversions/include;/usr/include/eigen3;/home/jbmdumont/catkin_ws/lib/orocos_kdl/build/../../../include;/usr/local/include/eigen3 " STREQUAL " ")
  set(eigen_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/home/jbmdumont/catkin_ws/src/geometry/eigen_conversions/include;/usr/include/eigen3;/home/jbmdumont/catkin_ws/lib/orocos_kdl/build/../../../include;/usr/local/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jbmdumont/catkin_ws/src/geometry/eigen_conversions/${idir}'.  ${_report}")
    endif()
    _list_append_unique(eigen_conversions_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "eigen_conversions;/home/jbmdumont/catkin_ws/lib/orocos_kdl/build/src/liborocos-kdl.so.1.4.0")
