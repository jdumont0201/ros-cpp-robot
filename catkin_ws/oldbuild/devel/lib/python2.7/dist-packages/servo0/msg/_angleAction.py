...
"""autogenerated by genpy from servo0/angleAction.msg. Do not edit."""
import sys
...
class angleAction(genpy.Message):
  _md5sum = "295e95871e77e896b90842ab16fa8690"
  _type = "servo0/angleAction"
...
"""
  ...
  _slot_types = ['servo0/angleActionGoal','servo0/angleActionResult','servo0/angleActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(angleAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = servo0.msg.angleActionGoal()
      if self.action_result is None:
        self.action_result = servo0.msg.angleActionResult()
      if self.action_feedback is None:
        self.action_feedback = servo0.msg.angleActionFeedback()
    else:
      self.action_goal = servo0.msg.angleActionGoal()
      self.action_result = servo0.msg.angleActionResult()
      self.action_feedback = servo0.msg.angleActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_f3I().pack(_x.action_goal.goal.target_angle, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_f().pack(self.action_feedback.feedback.feedback))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.target_angle, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
