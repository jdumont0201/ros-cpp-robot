...
"""autogenerated by genpy from servo0/angleActionResult.msg. Do not edit."""
import sys
...
class angleActionResult(genpy.Message):
  _md5sum = "45d05b4bc67705fb63559b92fb813aca"
  _type = "servo0/angleActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','servo0/angleResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(angleActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = servo0.msg.angleResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = servo0.msg.angleResult()
