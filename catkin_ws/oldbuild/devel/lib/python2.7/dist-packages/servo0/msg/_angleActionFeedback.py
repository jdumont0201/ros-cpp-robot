...
"""autogenerated by genpy from servo0/angleActionFeedback.msg. Do not edit."""
import sys
...
class angleActionFeedback(genpy.Message):
  _md5sum = "34457bd6d156bddddfc82fc14102ebdf"
  _type = "servo0/angleActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','servo0/angleFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(angleActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = servo0.msg.angleFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = servo0.msg.angleFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_f().pack(self.feedback.feedback))
