...
(cl:defmethod cl:initialize-instance :after ((m <mode-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'mode-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name led0-srv:<mode-request> is deprecated: use led0-srv:mode-request instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <mode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader led0-srv:status-val is deprecated.  Use led0-srv:status instead.")
  (status m))
...
(cl:defmethod cl:initialize-instance :after ((m <mode-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'mode-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name led0-srv:<mode-response> is deprecated: use led0-srv:mode-response instead.")))

(cl:ensure-generic-function 'res-val :lambda-list '(m))
(cl:defmethod res-val ((m <mode-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader led0-srv:res-val is deprecated.  Use led0-srv:res instead.")
  (res m))
