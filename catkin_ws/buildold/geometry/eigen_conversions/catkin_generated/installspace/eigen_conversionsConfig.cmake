...
if(NOT "include;/usr/include/eigen3;/home/jbmdumont/catkin_ws/lib/orocos_kdl/build/../../../include;/usr/local/include/eigen3 " STREQUAL " ")
  set(eigen_conversions_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include/eigen3;/home/jbmdumont/catkin_ws/lib/orocos_kdl/build/../../../include;/usr/local/include/eigen3")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jbmdumont/catkin_ws/install/${idir}'.  ${_report}")
    endif()
